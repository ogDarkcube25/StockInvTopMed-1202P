 ...
 * @author Cashmere
 */
public class productu extends javax.swing.JFrame {
...
public ArrayList<User> getUsersList(){
    ...
    String query = "SELECT * FROM `prod` WHERE `status` = 'Active'";
...
//         if (query.contains("50")) { JOptionPane.showMessageDialog(null, "WARNING! NEAR OS DETECTED");
 ...
 public void executeSQLQuery(String query, String message){
    ...
    private void initComponents() {
        ...
        jButton6.setText("VIEW ARCHIVED VACCINE");
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            Class[] types = new Class [] {
                java.lang.Integer.class, java.lang.Object.class, java.lang.Integer.class, java.lang.Integer.class, java.lang.Integer.class, java.lang.String.class, java.lang.Integer.class, java.lang.String.class
            };
...
public static void logAction(int userId, String action){
    try (Connection con = getConnection()) {
        PreparedStatement ps = con.prepareStatement("INSET INTO `log` (`user_id`, `action`, `timestamp`) VALUES (?, ?, NOW())");
        ps.setInt(1, userId);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(productu.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
