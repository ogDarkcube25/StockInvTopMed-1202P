 ...
 * @author Cashmere
 */
public class varch extends javax.swing.JFrame {
...
public ArrayList<User> getUsersList(){
    ...
    String query = "SELECT * FROM `prod` WHERE `status` = 'Archived'";    
    Statement stm;
    ResultSet rs;
...
public void executeSQLQuery(String query, String message){
    ...
    private void initComponents() {
        ...
        jLabel1.setText("ARCHIVED VACCINE");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
        sqlconnect.logAction(login.Session.currentUserId ,"RECOVERED PRODUCT");
        ...
        String query = "UPDATE prod SET status = 'Active' WHERE id = '"+jTextField2.getText()+"';";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(varch.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
