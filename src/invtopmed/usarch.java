 ...
 * @author Cashmere
 */
public class usarch extends javax.swing.JFrame {
...
public ArrayList<User> getUsersList(){
    ...
    String query = "SELECT * FROM `user` WHERE `st` = 'Archive'";    
    Statement stm;
    ResultSet rs;
    ...
    try {
        ...
        User user;
    while (rs.next()) {
        user = new User(rs.getInt("id"), rs.getString("uname"), rs.getString("fname"), rs.getString("password"), rs.getBoolean("access"), rs.getString("st"));
        userList.add(user);
    }
    } catch (Exception e) {
        e.printStackTrace();
...
public void executeSQLQuery(String query, String message){
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Id", "Username", "Fullname", "Password", "Access"
            }
        ) {
        ...
        jLabel3.setText("RECOVER VACCINE");
        ...
        jLabel5.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(51, 102, 255)));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
        int chooser = JOptionPane.showConfirmDialog(null, "Are you sure you want to RECOVER this vaccine?", "Confirm", JOptionPane.YES_NO_OPTION);
         
         if (chooser == JOptionPane.YES_OPTION) {
        String query = "UPDATE user SET st = 'Active', access = '1' WHERE id = '"+jTextField2.getText()+"';";
        executeSQLQuery(query, "Recovered ");
        dispose();
         } else {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(usarch.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
