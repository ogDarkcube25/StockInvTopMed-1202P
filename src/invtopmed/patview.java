...
public ArrayList<User> getUsersList(){
    ...
    String query = "SELECT * FROM `susage` ";
    ...
    try {
        ...
        User user;
    while (rs.next()) {
        user = new User(rs.getInt("id"), rs.getString("reto"), rs.getString("vname"), rs.getInt("noused"), rs.getDate("dte"));
        userList.add(user);
    }
    } catch (Exception e) {
        e.printStackTrace();
...
public void Show_Users_JTable() {
    ...
    for(int i=0; i<list.size(); i++) {
       ...
       row[0] = list.get(i).getSId();
        row[2] = list.get(i).getVname();
        row[3] = list.get(i).getnUs();
        row[1] = list.get(i).getreTo();
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Id", "Patients", "Vaccine", "No. of  Used", "Date"
            }
        ) {
